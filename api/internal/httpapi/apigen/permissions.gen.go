...
var OperationAuths = map[string]OperationAuth{
	"AdminApproveProof":            {Kind: AuthPermission, Permission: "proof_review", Access: "write"},
	...
	"AdminGetFile":                 {Kind: AuthPermission, Permission: "proof_review", Access: "read"},
	"AdminGetMe":                   {Kind: AuthSession},
	"AdminGetOrder":                {Kind: AuthPermission, Permission: "order_view", Access: "read"},
	"AdminGetProof":                {Kind: AuthPermission, Permission: "proof_review", Access: "read"},
	...
	"AdminListProofs":              {Kind: AuthPermission, Permission: "proof_review", Access: "read"},
	...
	"AdminRejectProof":             {Kind: AuthPermission, Permission: "proof_review", Access: "write"},
	...
	"AppRequestPhoneCode":          {Kind: AuthNone},
	"AppSubmitProof":               {Kind: AuthApp},
	"AppUpdateMe":                  {Kind: AuthApp},
	"AppUpdateProfile":             {Kind: AuthApp},
	"AppVerifyPhoneCode":           {Kind: AuthNone},
